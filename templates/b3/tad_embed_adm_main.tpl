  ...
  <style type="text/css" media="screen">
    ...
    <form action="main.php" method="post" id="myForm" enctype="multipart/form-data" class="form-horizontal" role="form">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <label class="radio-inline">
            <input type="radio" name="border" id="border_1" value="1" <{if $border==1}>checked<{/if}>>
            <{$smarty.const._YES}>
          </label>
          <label class="radio-inline">
            <input type="radio" name="border" id="border_0" value="0" <{if $border!=1}>checked<{/if}>>
            <{$smarty.const._NO}>
          </label>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <label class="radio-inline">
            <input type="radio" name="scrolling" id="scrolling_no" value="no" <{if $scrolling=='no'}>checked<{/if}>>
            <{$smarty.const._MA_TADEMBED_NO}>
          </label>
          <label class="radio-inline">
            <input type="radio" name="scrolling" id="scrolling_yes" value="yes" <{if $scrolling=='yes'}>checked<{/if}>>
            <{$smarty.const._MA_TADEMBED_YES}>
          </label>
          <label class="radio-inline">
            <input type="radio" name="scrolling" id="scrolling_auto" value="auto" <{if $scrolling=='auto' or $border==""}>checked<{/if}>>
            <{$smarty.const._MA_TADEMBED_AUTO}>
          </label>
        </div>
      </div>
